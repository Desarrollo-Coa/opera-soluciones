...
export function AuditorDashboard() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Hola mundo - Auditor</h1>
        <p className="text-gray-600 mt-2">Panel de auditoría con acceso a módulos principales</p>
      </div>
