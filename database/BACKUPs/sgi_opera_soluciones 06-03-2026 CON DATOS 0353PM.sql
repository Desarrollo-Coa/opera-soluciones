...
-- Tiempo de generación: 06-03-2026 a las 20:52:25
...
--
-- Volcado de datos para la tabla `OS_ARCHIVOS`
--

INSERT INTO `OS_ARCHIVOS` (`AF_IDARCHIVO_PK`, `AF_NOMBRE`, `AF_NOMBRE_ORIGINAL`, `CF_IDCARPETA_FK`, `AF_RUTA_ARCHIVO`, `AF_URL_ARCHIVO`, `AF_TAMANO`, `AF_TIPO_MIME`, `AF_EXTENSION`, `AF_DESCRIPCION`, `AF_CREADO_POR`, `AF_FECHA_CREACION`, `AF_ACTIVO`) VALUES
...
CREATE TABLE `OS_AUSENCIAS` (
  ...
  `AU_DESCRIPCION` text,
  `AU_SOPORTE_URL` varchar(255) DEFAULT NULL,
  `AU_IDUSUARIO_REGISTRO` int NOT NULL,
...
--
-- Volcado de datos para la tabla `OS_CAJAS_COMPENSACION`
--

INSERT INTO `OS_CAJAS_COMPENSACION` (`CC_IDCAJA_PK`, `CC_NOMBRE`, `CC_ACTIVO`) VALUES
(1, 'COMFAMA', 1),
(2, 'COMFENALCO', 1),
(3, 'COMPENSAR', 1),
(4, 'CAFAM', 1),
(5, 'COLSUBSIDIO', 1),
(6, 'CAJACOPI ATLANTICO', 1),
(7, 'COMFANDI', 1),
(8, 'COMFENALCO VALLE', 1),
(9, 'COMBARRANQUILLA', 1),
(10, 'COMFACUNDI', 1),
(11, 'COMFAMILIAR', 1);
...
--
-- Volcado de datos para la tabla `OS_CARGOS`
--

INSERT INTO `OS_CARGOS` (`CA_IDCARGO_PK`, `CA_NOMBRE`, `CA_SUELDO_BASE`, `CA_JORNADA_DIARIA`, `CA_APLICA_AUXILIO`, `CA_CLASE_RIESGO_ARL`, `CA_PORCENTAJE_RIESGO_ARL`, `CA_DESCRIPCION`, `CA_ACTIVO`, `CA_FECHA_CREACION`, `CA_CREADO_POR`, `CA_ACTUALIZADO_POR`) VALUES
(1, 'VIVIENTE', '1750905.00', 8, 1, 'Riesgo I - 0.522%', '0.522', 'Personal de servicios generales/viviencia', 1, '2026-03-06 13:46:54', 1, NULL),
(2, 'AUX SERVICIOS GENERALES', '1750905.00', 8, 1, 'Riesgo I - 0.522%', '0.522', 'Personal de mantenimiento y oficios varios', 1, '2026-03-06 13:46:54', 1, 1),
(3, 'Gestor de SST', '2280000.00', 8, 1, 'Riesgo I - 0.522%', '0.522', 'Líder de Seguridad y Salud en el Trabajo', 1, '2026-03-06 13:46:54', 1, 1),
(4, 'CONTADOR', '4500000.00', 8, 0, 'Riesgo I - 0.522%', '0.522', 'Responsable del área contable', 1, '2026-03-06 13:46:54', 1, NULL),
(5, 'ASISTENTE ADMINISTRATIVO', '2000000.00', 8, 1, 'Riesgo I - 0.522%', '0.522', 'Apoyo operativo administrativo', 1, '2026-03-06 13:46:54', 1, NULL),
(6, 'GERENTE', '8000000.00', 8, 0, 'Riesgo I - 0.522%', '0.522', 'Alta gerencia', 1, '2026-03-06 13:46:54', 1, NULL),
(7, 'CEO', '12000000.00', 8, 0, 'Riesgo I - 0.522%', '0.522', 'Director Ejecutivo', 1, '2026-03-06 13:46:54', 1, NULL);
...
--
-- Volcado de datos para la tabla `OS_CARPETAS`
--

INSERT INTO `OS_CARPETAS` (`CF_IDCARPETA_PK`, `CF_NOMBRE`, `CF_IDCARPETA_PADRE_FK`, `CF_RUTA`, `CF_DESCRIPCION`, `CF_CREADO_POR`, `CF_FECHA_CREACION`, `CF_ACTIVO`) VALUES
...
--
-- Volcado de datos para la tabla `OS_CONCEPTOS_NOMINA`
--

INSERT INTO `OS_CONCEPTOS_NOMINA` (`CN_IDCONCEPTO_PK`, `CN_NOMBRE`, `CN_TIPO`, `CN_AFECTA_IBC_SALUD`, `CN_AFECTA_IBC_PENSION`, `CN_AFECTA_IBC_ARL`, `CN_CONSTITUTIVO_SALARIO`, `CN_ES_NOVEDAD`, `CN_FECHA_CREACION`) VALUES
('DED001', 'Salud (Empleado 4%)', 'Deducción', 0, 0, 0, 0, 0, '2026-03-06 13:46:42'),
('DED002', 'Pensión (Empleado 4%)', 'Deducción', 0, 0, 0, 0, 0, '2026-03-06 13:46:42'),
('DED003', 'Préstamo / Libranza', 'Deducción', 0, 0, 0, 0, 1, '2026-03-06 13:46:42'),
('DED004', 'Otras Deducciones', 'Deducción', 0, 0, 0, 0, 1, '2026-03-06 13:46:42'),
('DEV001', 'Sueldo Básico', 'Devengo', 1, 1, 1, 1, 0, '2026-03-06 13:46:42'),
('DEV002', 'Auxilio de Transporte', 'Devengo', 0, 0, 0, 0, 0, '2026-03-06 13:46:42'),
('DEV003', 'Bonificación / Comisión', 'Devengo', 1, 1, 1, 1, 1, '2026-03-06 13:46:42');
...
--
-- Volcado de datos para la tabla `OS_DEPARTAMENTOS`
--

INSERT INTO `OS_DEPARTAMENTOS` (`DE_IDDEPARTAMENTO_PK`, `DE_NOMBRE`) VALUES
(5, 'Antioquia'),
(8, 'Atlántico'),
(11, 'Bogotá D.C.'),
(13, 'Bolívar'),
...
--
-- Volcado de datos para la tabla `OS_ENTIDADES_ARL`
--

INSERT INTO `OS_ENTIDADES_ARL` (`AR_IDARL_PK`, `AR_NOMBRE`, `AR_ACTIVO`) VALUES
(1, 'ARL SURA (Seguros Generales Suramericana)', 1),
(2, 'ARL POSITIVA (Positiva Compañía de Seguros)', 1),
(3, 'ARL AXA COLPATRIA (Axa Colpatria Seguros)', 1),
(4, 'ARL LIBERTY (Liberty Seguros)', 1),
(5, 'ARL COLMENA (Colmena Seguros)', 1),
(6, 'ARL BOLIVAR (Seguros Bolívar)', 1),
(7, 'LA EQUIDAD SEGUROS', 1),
(8, 'COMPAÑÍA DE SEGUROS DE VIDA AURORA', 1);
...
--
-- Volcado de datos para la tabla `OS_ENTIDADES_BANCARIAS`
--

INSERT INTO `OS_ENTIDADES_BANCARIAS` (`EB_IDBANCO_PK`, `EB_NOMBRE`, `EB_ACTIVO`) VALUES
(1, 'BANCOLOMBIA', 1),
(2, 'BANCO DE BOGOTÁ', 1),
(3, 'DAVIVIENDA', 1),
(4, 'BBVA COLOMBIA', 1),
(5, 'SCOTIABANK COLPATRIA', 1),
(6, 'ITAU', 1),
(7, 'BANCO DE OCCIDENTE', 1),
(8, 'NEQUI', 1),
(9, 'DAVIPLATA', 1),
(10, 'BANCO POPULAR', 1),
(11, 'BANCO FALABELLA', 1),
(12, 'BANCO AGRARIO', 1);
...
--
-- Volcado de datos para la tabla `OS_ENTIDADES_EPS`
--

INSERT INTO `OS_ENTIDADES_EPS` (`EP_IDEPS_PK`, `EP_NOMBRE`, `EP_CODIGO_MINPROTECCION`, `EP_ACTIVO`) VALUES
(1, 'COOSALUD EPS - S', 'ESS024 / EPS042', 1),
(2, 'NUEVA EPS', 'EPS037 / EPSS41', 1),
(3, 'MUTUAL SER', 'ESS207 / EPS048', 1),
(4, 'SALUD MIA EPS', 'EPS046', 1),
(5, 'ALIANSALUD EPS', 'EPS001', 1),
(6, 'SALUD TOTAL EPS S.A.', 'EPS002', 1),
(7, 'EPS SANITAS', 'EPS005', 1),
(8, 'EPS SURA', 'EPS010', 1),
(9, 'FAMISANAR EPS', 'EPS017', 1),
(10, 'SERVICIO OCCIDENTAL DE SALUD EPS - SOS', 'EPS018', 1),
(11, 'COMFENALCO VALLE EPS', 'EPS012', 1),
(12, 'COMPENSAR EPS', 'EPS008', 1),
(13, 'CAPITAL SALUD EPS - S', 'EPSS34', 1),
(14, 'SAVIA SALUD EPS', 'EPSS40', 1),
(15, 'ASMET SALUD', 'ESS062', 1),
(16, 'EPS FAMILIAR DE COLOMBIA', 'CCF033', 1),
(17, 'DUSAKAWI EPSI', 'EPSI01', 1);
...
--
-- Volcado de datos para la tabla `OS_ENTIDADES_PENSION`
--

INSERT INTO `OS_ENTIDADES_PENSION` (`PE_IDPENSION_PK`, `PE_NOMBRE`, `PE_ACTIVO`) VALUES
(1, 'PROTECCIÓN', 1),
(2, 'PORVENIR', 1),
(3, 'COLFONDOS', 1),
(4, 'COLPENSIONES (Régimen de Prima Media)', 1),
(5, 'SKANDIA (Old Mutual)', 1);
...
--
-- Volcado de datos para la tabla `OS_ESTADOS_CONTRATO`
--

INSERT INTO `OS_ESTADOS_CONTRATO` (`EC_IDESTADO_CONTRATO_PK`, `EC_NOMBRE`, `EC_DESCRIPCION`, `EC_ACTIVO`, `EC_FECHA_CREACION`, `EC_CREADO_POR`, `EC_ACTUALIZADO_POR`) VALUES
...
--
-- Volcado de datos para la tabla `OS_FACTURACION`
--

INSERT INTO `OS_FACTURACION` (`FA_IDFACTURA_PK`, `FA_ANIO`, `FA_MES`, `FA_NUMERO_FACTURACION`, `FA_FECHA`, `FA_CLIENTE`, `FA_SERVICIO`, `FA_NIT`, `FA_VALOR`, `FA_IVA`, `FA_TOTAL`, `FA_FECHA_CREACION`, `FA_CREADO_POR`, `FA_ACTUALIZADO_POR`) VALUES
...
--
-- Volcado de datos para la tabla `OS_MODALIDADES_TRABAJO`
--

INSERT INTO `OS_MODALIDADES_TRABAJO` (`MT_IDMODALIDAD_PK`, `MT_NOMBRE`) VALUES
(6, 'Híbrido'),
(2, 'Medio Tiempo'),
(4, 'Por Contrato'),
(3, 'Por Horas'),
...
--
-- Volcado de datos para la tabla `OS_MUNICIPIOS`
--

INSERT INTO `OS_MUNICIPIOS` (`MU_IDMUNICIPIO_PK`, `DE_IDDEPARTAMENTO_FK`, `MU_NOMBRE`) VALUES
(5001, 5, 'Medellín'),
(5002, 5, 'Abejorral'),
(5004, 5, 'Abriaquí'),
(5021, 5, 'Alejandría'),
...
--
-- Volcado de datos para la tabla `OS_PARAMETROS_NOMINA`
--

INSERT INTO `OS_PARAMETROS_NOMINA` (`PN_IDPARAMETRO_PK`, `PN_ANIO_VIGENCIA`, `PN_SMMLV`, `PN_AUXILIO_TRANSPORTE`, `PN_HORAS_SEMANALES_MAX`, `PN_HORAS_MENSUALES_PROM`, `PN_FECHA_CAMBIO_JORNADA`, `PN_NUEVAS_HORAS_SEMANALES`, `PN_NUEVAS_HORAS_MENSUALES`, `PN_FECHA_CREACION`) VALUES
(1, 2026, '1750905.00', '249095.00', 44, 220, '2026-07-15', 42, 210, '2026-03-06 13:46:41');
...
--
-- Volcado de datos para la tabla `OS_ROLES`
--

INSERT INTO `OS_ROLES` (`RO_IDROL_PK`, `RO_NOMBRE`, `RO_CODIGO`, `RO_DESCRIPCION`, `RO_ACTIVO`, `RO_FECHA_CREACION`, `RO_CREADO_POR`, `RO_ACTUALIZADO_POR`) VALUES
...
--
-- Volcado de datos para la tabla `OS_TIPOS_AUSENCIA`
--

INSERT INTO `OS_TIPOS_AUSENCIA` (`TA_IDTIPO_AUSENCIA_PK`, `TA_NOMBRE`, `TA_DESCRIPCION`, `TA_PORCENTAJE_PAGO`, `TA_AFECTA_AUXILIO`, `TA_ACTIVO`, `TA_FECHA_CREACION`, `TA_CREADO_POR`, `TA_ACTUALIZADO_POR`) VALUES
(1, 'Ausencia', 'Ausencia injustificada o permiso no remunerado', '0.00', 1, 1, '2026-03-06 13:46:43', 1, NULL),
(2, 'Incapacidad', 'Incapacidad común o laboral', '66.67', 1, 1, '2026-03-06 13:46:43', 1, NULL),
(3, 'Vacaciones', 'Disfrute de días de vacaciones (pago en liquidación)', '0.00', 1, 1, '2026-03-06 13:46:43', 1, NULL);
...
--
-- Volcado de datos para la tabla `OS_TIPOS_DOCUMENTO`
--

INSERT INTO `OS_TIPOS_DOCUMENTO` (`TD_IDTIPO_DOCUMENTO_PK`, `TD_NOMBRE`, `TD_DESCRIPCION`, `TD_ACTIVO`, `TD_FECHA_CREACION`, `TD_CREADO_POR`, `TD_ACTUALIZADO_POR`) VALUES
...
--
-- Volcado de datos para la tabla `OS_TRANSFERENCIAS`
--

INSERT INTO `OS_TRANSFERENCIAS` (`TR_IDTRANSFERENCIA_PK`, `TR_ANIO`, `TR_MES`, `TR_FECHA`, `TR_ACTIVIDAD`, `TR_SALE`, `TR_ENTRA`, `TR_SALDO`, `TR_CONCEPTO`, `TR_FECHA_CREACION`, `TR_CREADO_POR`, `TR_ACTUALIZADO_POR`) VALUES
...
--
-- Volcado de datos para la tabla `OS_USUARIOS`
--

INSERT INTO `OS_USUARIOS` (`US_IDUSUARIO_PK`, `US_NOMBRE`, `US_APELLIDO`, `US_EMAIL`, `US_PASSWORD_HASH`, `US_TIPO_DOCUMENTO`, `US_NUMERO_DOCUMENTO`, `US_FECHA_NACIMIENTO`, `US_GENERO`, `US_ESTADO_CIVIL`, `US_CONTACTO_EMERGENCIA_NOMBRE`, `US_CONTACTO_EMERGENCIA_TELEFONO`, `US_TELEFONO`, `US_DIRECCION`, `DE_IDDEPARTAMENTO_FK`, `MU_IDMUNICIPIO_FK`, `US_FECHA_CONTRATACION`, `US_FECHA_RETIRO`, `US_HORARIO_TRABAJO`, `US_DEPARTAMENTO`, `US_IDMANAGER_FK`, `US_TIPO_EMPLEO`, `EP_IDEPS_FK`, `AR_IDARL_FK`, `PE_IDPENSION_FK`, `CC_IDCAJA_FK`, `US_NOMBRE_BANCO`, `US_NUMERO_CUENTA`, `US_TIPO_CUENTA`, `US_FOTO_PERFIL`, `US_NOTAS`, `US_ACTIVO`, `RO_IDROL_FK`, `CA_IDCARGO_FK`, `EC_IDESTADO_CONTRATO_FK`, `US_FECHA_CREACION`, `US_CREADO_POR`, `US_ACTUALIZADO_POR`, `US_FECHA_ELIMINACION`, `US_ELIMINADO_POR`) VALUES
(1, 'Juan Manuel', 'Administrador', 'juanmanuel@operasoluciones.com', '$2a$12$UH3BnGQSh6mHS2dKRz0j.OpO6jEe7tVSIOjgJofbIGtL23k3mITdm', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, 1, '2025-09-18 12:20:41', 1, NULL, NULL, NULL),
(2, 'Daniel', 'Ramirez', 'daniel.ramirez@operasoluciones.com', '$2a$12$1A/jF1I6fG1MjUekPAlb4Ohq1qG3L/1AaIUh74h69Ek.9P11HlIny', 'CC', '3189139831', '1995-06-01', 'M', 'Soltero/a', 'María Ramirez', '3001234567', '3009876543', 'Calle 123 #45-67, Cartagena', NULL, NULL, '2023-08-30', NULL, '8:00 a.m - 5:00 p.m.', 'Tecnología', 1, 'Tiempo Completo', 'SURA', 'POSITIVA', 'PROTECCIÓN', 'CAJACOPI', 'BANCOLOMBIA', '1234567890', 'Ahorros', NULL, 'Desarrollador con experiencia en React y Node.js', 1, 2, NULL, 1, '2025-09-18 12:27:07', 1, 1, '2025-10-27 08:41:45', 1),
(3, 'María', 'González', 'maria.gonzalez@operasoluciones.com', '$2a$12$1A/jF1I6fG1MjUekPAlb4Ohq1qG3L/1AaIUh74h69Ek.9P11HlIny', 'CC', '1234567890', '1990-03-15', 'F', 'Casado/a', 'Carlos González', '3002345678', '3008765432', 'Carrera 45 #78-90, Barranquilla', NULL, NULL, '2022-01-15', NULL, '8:00 a.m - 6:00 p.m.', 'Recursos Humanos', 1, 'Tiempo Completo', 'SANITAS', 'SURA', 'COLFONDOS', 'CAJACOPI', 'BBVA', '2345678901', 'Corriente', NULL, 'Experta en gestión de talento humano', 1, 3, NULL, 1, '2025-01-27 10:00:00', 1, NULL, '2025-10-27 08:42:25', 1),
(4, 'Carlos', 'Mendoza', 'carlos.mendoza@operasoluciones.com', '$2a$12$1A/jF1I6fG1MjUekPAlb4Ohq1qG3L/1AaIUh74h69Ek.9P11HlIny', 'CC', '2345678901', '1988-11-22', 'M', 'Soltero/a', 'Ana Mendoza', '3003456789', '3007654321', 'Calle 67 #12-34, Medellín', NULL, NULL, '2021-06-01', NULL, '8:00 a.m - 5:00 p.m.', 'Contabilidad', 1, 'Tiempo Completo', 'NUEVA EPS', 'POSITIVA', 'PROTECCIÓN', 'CAJACOPI', 'SCOTIABANK', '3456789012', 'Ahorros', NULL, 'Contador público con especialización en tributaria', 1, 2, NULL, 1, '2025-01-27 10:00:00', 1, NULL, '2025-10-27 08:42:28', 1),
(5, 'Ana', 'Rodríguez', 'ana.rodriguez@operasoluciones.com', '$2a$12$1A/jF1I6fG1MjUekPAlb4Ohq1qG3L/1AaIUh74h69Ek.9P11HlIny', 'CC', '3456789012', '1992-07-08', 'F', 'Soltero/a', 'Luis Rodríguez', '3004567890', '3006543210', 'Carrera 89 #23-45, Bogotá', NULL, NULL, '2023-02-15', NULL, '8:00 a.m - 5:00 p.m.', 'Tecnología', 2, 'Tiempo Completo', 'SURA', 'SURA', 'COLFONDOS', 'CAJACOPI', 'BANCOLOMBIA', '4567890123', 'Ahorros', NULL, 'Analista especializada en sistemas de información', 1, 2, NULL, 1, '2025-01-27 10:00:00', 1, NULL, '2025-10-27 08:42:32', 1),
(6, 'Luis', 'Hernández', 'luis.hernandez@operasoluciones.com', '$2a$12$1A/jF1I6fG1MjUekPAlb4Ohq1qG3L/1AaIUh74h69Ek.9P11HlIny', 'CC', '4567890123', '1985-12-03', 'M', 'Casado/a', 'Carmen Hernández', '3005678901', '3005432109', 'Calle 12 #56-78, Cali', NULL, NULL, '2020-09-01', NULL, '7:00 a.m - 4:00 p.m.', 'Construcción', 1, 'Tiempo Completo', 'SANITAS', 'POSITIVA', 'PROTECCIÓN', 'CAJACOPI', 'BBVA', '5678901234', 'Corriente', NULL, 'Supervisor con 10 años de experiencia en construcción', 1, 2, NULL, 1, '2025-01-27 10:00:00', 1, NULL, '2025-10-27 08:42:36', 1),
(7, 'Carmen', 'Vargas', 'carmen.vargas@operasoluciones.com', '$2a$12$1A/jF1I6fG1MjUekPAlb4Ohq1qG3L/1AaIUh74h69Ek.9P11HlIny', 'CC', '5678901234', '1993-04-18', 'F', 'Soltero/a', 'Roberto Vargas', '3006789012', '3004321098', 'Carrera 34 #67-89, Bucaramanga', NULL, NULL, '2023-05-20', NULL, '8:00 a.m - 5:00 p.m.', 'Administración', 3, 'Tiempo Completo', 'NUEVA EPS', 'SURA', 'COLFONDOS', 'CAJACOPI', 'SCOTIABANK', '6789012345', 'Ahorros', NULL, 'Asistente administrativa con experiencia en gestión documental', 1, 2, NULL, 1, '2025-01-27 10:00:00', 1, NULL, '2025-10-27 08:42:39', 1),
(8, 'Roberto', 'Silva', 'roberto.silva@operasoluciones.com', '$2a$12$1A/jF1I6fG1MjUekPAlb4Ohq1qG3L/1AaIUh74h69Ek.9P11HlIny', 'CC', '6789012345', '1987-09-25', 'M', 'Divorciado/a', 'Patricia Silva', '3007890123', '3003210987', 'Calle 78 #90-12, Pereira', NULL, NULL, '2019-03-10', NULL, '8:00 a.m - 5:00 p.m.', 'Ingeniería', 1, 'Tiempo Completo', 'SANITAS', 'POSITIVA', 'PROTECCIÓN', 'CAJACOPI', 'BANCOLOMBIA', '7890123456', 'Corriente', NULL, 'Ingeniero civil especializado en estructuras', 1, 2, NULL, 1, '2025-01-27 10:00:00', 1, NULL, '2025-10-27 08:42:43', 1),
(9, 'Patricia', 'Morales', 'patricia.morales@operasoluciones.com', '$2a$12$1A/jF1I6fG1MjUekPAlb4Ohq1qG3L/1AaIUh74h69Ek.9P11HlIny', 'CC', '7890123456', '1991-01-12', 'F', 'Casado/a', 'Fernando Morales', '3008901234', '3002109876', 'Carrera 56 #78-90, Manizales', NULL, NULL, '2022-08-15', NULL, '8:00 a.m - 5:00 p.m.', 'Auditoría', 1, 'Tiempo Completo', 'SURA', 'SURA', 'COLFONDOS', 'CAJACOPI', 'BBVA', '8901234567', 'Ahorros', NULL, 'Auditora con certificación en normas internacionales', 1, 4, NULL, 1, '2025-01-27 10:00:00', 1, NULL, '2025-10-27 08:42:46', 1),
(10, 'Fernando', 'Castro', 'fernando.castro@operasoluciones.com', '$2a$12$1A/jF1I6fG1MjUekPAlb4Ohq1qG3L/1AaIUh74h69Ek.9P11HlIny', 'CC', '8901234567', '1989-06-30', 'M', 'Soltero/a', 'Isabel Castro', '3009012345', '3001098765', 'Calle 90 #12-34, Armenia', NULL, NULL, '2021-11-01', NULL, '8:00 a.m - 6:00 p.m.', 'Proyectos', 1, 'Tiempo Completo', 'NUEVA EPS', 'POSITIVA', 'PROTECCIÓN', 'CAJACOPI', 'SCOTIABANK', '9012345678', 'Corriente', NULL, 'Coordinador con PMP y experiencia en gestión de proyectos', 1, 2, NULL, 1, '2025-01-27 10:00:00', 1, NULL, '2025-10-27 08:42:48', 1),
(11, 'Isabel', 'Jiménez', 'isabel.jimenez@operasoluciones.com', '$2a$12$1A/jF1I6fG1MjUekPAlb4Ohq1qG3L/1AaIUh74h69Ek.9P11HlIny', 'CC', '9012345678', '1994-08-14', 'F', 'Soltero/a', 'Miguel Jiménez', '3000123456', '3000987654', 'Carrera 12 #34-56, Pasto', NULL, NULL, '2023-07-01', NULL, '8:00 a.m - 5:00 p.m.', 'Diseño', 1, 'Tiempo Completo', 'SANITAS', 'SURA', 'COLFONDOS', 'CAJACOPI', 'BANCOLOMBIA', '0123456789', 'Ahorros', NULL, 'Diseñadora gráfica especializada en branding corporativo', 1, 2, NULL, 1, '2025-01-27 10:00:00', 1, NULL, '2025-10-27 08:42:51', 1),
(12, 'Miguel', 'Torres', 'miguel.torres@operasoluciones.com', '$2a$12$1A/jF1I6fG1MjUekPAlb4Ohq1qG3L/1AaIUh74h69Ek.9P11HlIny', 'CC', '0123456789', '1986-02-28', 'M', 'Casado/a', 'Elena Torres', '3001234567', '3009876543', 'Calle 45 #67-89, Santa Marta', NULL, NULL, '2020-12-01', NULL, '6:00 a.m - 2:00 p.m.', 'Seguridad', 1, 'Tiempo Completo', 'NUEVA EPS', 'POSITIVA', 'PROTECCIÓN', 'CAJACOPI', 'BBVA', '1234567890', 'Corriente', NULL, 'Jefe de seguridad con certificación en gestión de riesgos', 1, 2, NULL, 1, '2025-01-27 10:00:00', 1, NULL, '2025-10-27 08:42:55', 1),
(13, 'EDGARDO JOSE ', 'HERNANDEZ HERAZO', 'JFJF@GMAIL.COM', '$2a$12$xJCIXZ3XB.aM34UbqzSCyeyu55gJj8/74NDsHD8k1et.fxnq.ssea', 'CC', '1052089540', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-10-23', '2025-10-22', 'DIURNO 8 HORAS', 'juanmanuel@operasoluciones.com', NULL, 'Tiempo Completo', NULL, 'SURA', NULL, 'CONFENALCO', NULL, NULL, NULL, NULL, 'INMOBILIARIA', 1, 2, NULL, 1, '2025-10-27 08:56:34', 1, 1, NULL, NULL),
(14, 'JUAN PABLO', 'RODRIGUEZ LEON', 'GDGDG@GMAIL.COM', '$2a$12$gyNYpUwecPNNCsv8TCMEsOnpcHOgXnIeo1ESwzAZR3SgAs0ER80d2', 'CC', '9237159', NULL, 'M', 'Soltero/a', NULL, NULL, NULL, NULL, NULL, NULL, '2024-10-23', '2025-10-22', 'DIURNO 8 HOIRAS', 'juanmanuel@operasoluciones.com', NULL, 'Por Horas', NULL, 'SURA', NULL, 'CONFENALCO', '1', '91272232542', 'Ahorros', NULL, 'Nomina ', 1, 2, 2, 1, '2025-10-27 08:59:29', 1, 1, NULL, NULL),
(15, 'JHON FREDY', 'HERRERA PEREZ', 'RERE@GMAIL.COM', '$2a$12$OcFKygtdeAv3/bhgr21bOee0DQ..rqMtjoegL6bx46EAxtt5g7GCK', 'CC', '1007713187', NULL, 'M', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-11-11', NULL, 'DIURNO 8 HORAS', 'juanmanuel@operasoluciones.com', NULL, 'Por Contrato', NULL, 'SURA', NULL, NULL, NULL, NULL, NULL, NULL, 'MERCANTIL', 0, 2, NULL, 3, '2025-10-27 09:02:51', 1, 1, '2026-03-06 14:03:40', 1),
(16, 'JHON JAIRO', 'HERRERA TEHERAN', 'OTOTO@GMAIL.COM', '$2a$12$va0oZMJyTfIPQs./M/H9HO5/g278ouXL9Y04Nw.jMaGdxjzRaquCe', 'CC', '92449545', NULL, 'M', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-02-21', NULL, NULL, 'juanmanuel@operasoluciones.com', NULL, 'Tiempo Completo', NULL, 'SURA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2, NULL, 3, '2025-10-27 09:19:10', 1, 1, '2026-03-06 14:03:31', 1),
(17, 'VALENTINA ', 'FERRER VARELA ', 'FDF@GMAIL.COM', '$2a$12$A7YPNEwS5NQB79r3o7Icr.y1borI9dL85.FlasaS5JdwTT19I6MEC', 'CC', '1143470112', NULL, 'F', 'Soltero/a', NULL, NULL, NULL, NULL, NULL, NULL, '2025-01-23', NULL, NULL, 'juanmanuel@operasoluciones.com', NULL, 'Tiempo Completo', NULL, 'SURA', NULL, NULL, NULL, NULL, NULL, 'https://sgiopera-prod-files.nyc3.digitaloceanspaces.com/profile-pictures/fd0e7ec6-98aa-49d6-9438-e98f5842ec93_748505.jpeg', NULL, 0, 2, NULL, 3, '2025-10-27 09:52:29', 1, 1, '2026-03-06 14:03:11', 1),
(18, 'MIGUEL ', 'POLO MENDOZA ', 'mpolo@gmail.com', '$2a$12$iohVQI1LgZrH9x0Do1EB4uUy19yBEn4q/SIka1kXREVs82QnUy4T.', 'CC', '1131007247', NULL, 'M', 'Unión Libre', NULL, NULL, NULL, NULL, NULL, NULL, '2025-07-02', NULL, '8  a.m -  5 p.m.', NULL, NULL, 'Por Contrato', NULL, NULL, NULL, '11', '1', '77000031499', 'Ahorros', NULL, NULL, 1, 2, 3, 1, '2026-03-06 14:37:16', 1, NULL, NULL, NULL),
(19, 'JORGE ', 'GALAN GUERRA', 'jgalan@gmail.com', '$2a$12$jzZ7jHPMocWqWN3didP6LOvAEIKoFc6tVJcWEpXZRij1exUKvGRy2', 'CC', '85273123', NULL, 'M', 'Soltero/a', NULL, NULL, NULL, NULL, NULL, NULL, '2025-08-05', NULL, '8  a.m -  5 p.m.', NULL, NULL, 'Tiempo Completo', NULL, NULL, NULL, '2', '1', '49589584669', 'Ahorros', NULL, NULL, 1, 2, 2, 1, '2026-03-06 14:41:30', 1, NULL, NULL, NULL),
(20, 'ANDRES ', 'CASTELLAR CARMONA ', 'acastellar@gmail.com', '$2a$12$JzqHlTOM/KS/oEUln/R4U.xwRG/WGKhd1ifmkkWJmXDB7IKiAiSM.', 'CC', '73227459', NULL, 'M', 'Unión Libre', NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-12', NULL, NULL, NULL, NULL, 'Tiempo Completo', NULL, NULL, NULL, '2', '1', '50991217816', 'Ahorros', NULL, NULL, 1, 2, 2, 1, '2026-03-06 14:45:56', 1, NULL, NULL, NULL),
(21, 'LEIDER DAVID ', 'TORRES VECINO', 'atorres@gmail.com', '$2a$12$RwL/Wq0Xr8vPqjEl/6exh.OfBnmM17hSGuk6ROTjHcqZiJsYmkSCe', 'CC', '1078578902', NULL, 'M', 'Unión Libre', NULL, NULL, NULL, NULL, NULL, NULL, '2025-10-17', NULL, '8  a.m -  5 p.m.', NULL, NULL, 'Tiempo Completo', NULL, NULL, NULL, '11', '1', '91292783588', 'Ahorros', NULL, NULL, 1, 2, 2, 1, '2026-03-06 14:48:17', 1, NULL, NULL, NULL),
(22, 'ALESSANDRO', 'VIVARES FLOREZ', 'avivares@gmail.com', '$2a$12$U9iv6tDJ4/7pza8CZvcnNeZ6AUA9d1SgSNk3xdryLfMjoxU4PUC.K', 'CC', '1007298289', NULL, 'M', 'Unión Libre', NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-02', NULL, NULL, NULL, NULL, 'Tiempo Completo', NULL, NULL, NULL, NULL, '1', '43200002217', 'Ahorros', NULL, NULL, 1, 2, 2, 1, '2026-03-06 14:50:21', 1, NULL, NULL, NULL);
...
ALTER TABLE `OS_AUSENCIAS`
  ...
  ADD KEY `fk_ausencias_usuario_registro` (`AU_IDUSUARIO_REGISTRO`),
...
--
ALTER TABLE `OS_ARCHIVOS`
  MODIFY `AF_IDARCHIVO_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `OS_CAJAS_COMPENSACION`
  MODIFY `CC_IDCAJA_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `OS_CARGOS`
--
ALTER TABLE `OS_CARGOS`
  MODIFY `CA_IDCARGO_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `OS_CARPETAS`
--
ALTER TABLE `OS_CARPETAS`
  MODIFY `CF_IDCARPETA_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `OS_ENTIDADES_ARL`
  MODIFY `AR_IDARL_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `OS_ENTIDADES_BANCARIAS`
--
ALTER TABLE `OS_ENTIDADES_BANCARIAS`
  MODIFY `EB_IDBANCO_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `OS_ENTIDADES_EPS`
--
ALTER TABLE `OS_ENTIDADES_EPS`
  MODIFY `EP_IDEPS_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `OS_ENTIDADES_PENSION`
--
ALTER TABLE `OS_ENTIDADES_PENSION`
  MODIFY `PE_IDPENSION_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `OS_ESTADOS_CONTRATO`
--
ALTER TABLE `OS_ESTADOS_CONTRATO`
  MODIFY `EC_IDESTADO_CONTRATO_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `OS_FACTURACION`
--
ALTER TABLE `OS_FACTURACION`
  MODIFY `FA_IDFACTURA_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `OS_MODALIDADES_TRABAJO`
  MODIFY `MT_IDMODALIDAD_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `OS_PARAMETROS_NOMINA`
  MODIFY `PN_IDPARAMETRO_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `OS_ROLES`
--
ALTER TABLE `OS_ROLES`
  MODIFY `RO_IDROL_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `OS_TIPOS_AUSENCIA`
--
ALTER TABLE `OS_TIPOS_AUSENCIA`
  MODIFY `TA_IDTIPO_AUSENCIA_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `OS_TIPOS_DOCUMENTO`
--
ALTER TABLE `OS_TIPOS_DOCUMENTO`
  MODIFY `TD_IDTIPO_DOCUMENTO_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `OS_TRANSFERENCIAS`
--
ALTER TABLE `OS_TRANSFERENCIAS`
  MODIFY `TR_IDTRANSFERENCIA_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=695;

--
-- AUTO_INCREMENT de la tabla `OS_USUARIOS`
--
ALTER TABLE `OS_USUARIOS`
  MODIFY `US_IDUSUARIO_PK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
COMMIT;
